...
var data = { 
    ...
    "btn-Cal" : [
        ...
        ["10/07/2025", "Tuesday", "Lunch n'Lean - Instructional Strategies"],
        ...
        ["11/13/2025", "Thursday", "Lunch n'Lean - TBD"],
...
if (day.toLocaleDateString('en-Us') == "8/11/2025")
    ...
    document.getElementById("btn-allMass").click();
else if (day.toLocaleDateString('en-Us') == "10/16/2025")
    document.getElementById("btn-allMass").click();
